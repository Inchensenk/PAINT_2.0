    ...
    public partial class Form1 : Form
    {
        ...
        private void OnButtonBackgroundClick(object sender, EventArgs e)
        {
            ...
            if(ofd.ShowDialog()==DialogResult.OK)
            {
                ...
                {
                    MessageBox.Show("Ќевозможно открыть выбранный файл", "ќшибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
        ...
        private void OnPicMouseMove(object sender, MouseEventArgs e)
        {
            ...
            //начальна€ и конечна€ координаты дл€ определени€ высоты и ширины
            x = e.X;
            y = e.Y;
            sX = e.X-cX;
            sY = e.Y-cY;
        ...
        {
            //при отпускании мышки рисование завершаетс€
            paint = false;
